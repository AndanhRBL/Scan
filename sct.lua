--[[
    ROBLOX UI SCANNER + LIVE DISCOVERY
    Delta-compatible client-side tool
...
local function attachWatch()
    ...
    local function refreshWatch()
        ...
        task.delay(WATCH_DEBOUNCE, function()
            ...
            rebuildTree()
            statusLabel.Text = "Watching | " .. #allRecords .. " objects"
        end)
    end
...
local function exportFolder()
    ...
    local root = "Delta_UI_Scanner_Export"
